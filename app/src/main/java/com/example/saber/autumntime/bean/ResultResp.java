...
public class ResultResp {
    ...
    public void setSource_data(SourceData source_data) {
    ...
    public String toString() {
        return "ResultResp{" +
                "link_v2_sync_img='" + link_v2_sync_img + '\'' +
                ", source_name='" + source_name + '\'' +
                ", video_url='" + video_url + '\'' +
                ", current_user_has_collected=" + current_user_has_collected +
                ", likings_count=" + likings_count +
                ", images=" + images +
